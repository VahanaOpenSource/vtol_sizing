...
#icol           = 10             # rank by GTOW
icol           = 11             # rank by Power installed
#icol           = 12             # rank by smallest rotor
#icol           = 16             # rank by fuel/battery weight 
#icol           = 17             # rank by empty weight
#icol           = 18             # rank by CT/sigma
#icol           = 20             # rank by max payload
#====================================================================
#16 = fuel/battery, 
#10 = GTOW, 
#11 = Power, 
...
constraints     = {'DL': 30, 'CTsigma': 0.14}
...
for path in path_list: 
   k, yl       = append_plot_data(path, all_data, icol-1, constraints)
