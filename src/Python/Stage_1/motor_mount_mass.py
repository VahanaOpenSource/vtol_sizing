...
def spar_mass(r1,taper,L,MbyA,Masses,xposn,Thrusts,fn=6.0,tbyc=0.168):
    ...
    8. fn       = target natural frequency for half-wing, Hz 
    9.tbyc      = wing thickness to chord ratio
...
#loop over lumped masses, add thrust and gravity
            for x,M,T in zip(xnodes,masses,thrusts):
