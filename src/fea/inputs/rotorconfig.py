...
# ===================================================================
# 
# USER DEFINITION OF ROTOR ARRANGEMENT
#
# ===================================================================
...
#         'nrotor'          : 4,
#         'ncluster'        : 1,
#         'rotor_position'  : [[ -2.5*rb,  0.0],
#                              [  2.5*rb,  0.0],
#                              [  0.0,  rb],
#                              [  0.0, -rb]],
#         'clusterID'       : [0,0,0,0], # has to start from 0
#         'radius'          : [rb,rb,rs,rs],
...
#                              [ -1.25*rb, 3*rb],
#                              [  1.25*rb, 3*rb]],
#         'clusterID'       : [0,0,1,1,2,2,3,3], # has to start from 0
#         'radius'          : [rb]*8,
#         'cluster_position': [[2.5*rb,0],[0,-2.5*rb],[-2.5*rb,0],[0,2.5*rb]]
#        }


def arrangeRotors(nr,rb,rs):
   ...
   rotor = {
            ...
            'rotor_position'  : [[  3*rb,  1.25*rb],
                                 ...
                                 [ -3*rb,  1.25*rb],
                                 [ -3*rb, -1.25*rb]],
            'clusterID'       : [0,0,1,1], # has to start from 0
            'radius'          : [rb]*4,
            'cluster_position': [[1.5*rb,0],[-1.5*rb,0]]
           }
