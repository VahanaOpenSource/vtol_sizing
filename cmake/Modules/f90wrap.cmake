...
#    FILE(WRITE "${path}\\final_part1.txt" "python C:\\Python27\\Scripts\\f2py-f90wrap -c -m _${proj} ${f90wrap_links}")
    set(f90wrap_options "--fcompiler=${CN} --f90flags=${PAR_FLAG} ${OMP} -I${moddir} --build-dir .")
  ...
  ENDIF()
#==============================================================
# write lines to text files to assemble the final compilation 
# command at the end; this roundabout way is needed because
# additional source files for the python wrapper are 
...
#==============================================================
# Copy the powershell script from CMake Module path to bin dir
# and execute the process to identify dynamically generated files
# print list of compiled files (temp) to screen to verify its 
# being identified correctly
#==============================================================

#      COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_MODULE_PATH}file_list.ps1 ${path}
      COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_MODULE_PATH}final.ps1     ${path}
      COMMENT ("CREATING SHARED OBJECT" ${SO})
      
#      execute_process(COMMAND POWERSHELL -ExecutionPolicy Bypass -File "file_list.ps1" 
#        OUTPUT_VARIABLE temp)     
#      MESSAGE(${temp})

#==============================================================
#Run a powershell script to read the 3 files, assemble the
# strings and run the command
#==============================================================

      execute_process(COMMAND POWERSHELL -ExecutionPolicy Bypass -File "final.ps1" 
        OUTPUT_VARIABLE temp2)

      MESSAGE("DONE, SEE IF API CREATED IN TARGET DIRECTORY!")
...
#      COMMAND ${temp2}   #-v
    ...
    add_custom_target(
      ...
      DEPENDS ${SO} API_${prj} ${temp2}
      COMMENT "creating shared object"
      VERBATIM)

#==============================================================
# For Mac and Linux, no need to futz around; the * wildcard 
# works nicely to identify files on the fly
#==============================================================
